...
document.addEventListener('DOMContentLoaded', function () {
  ...
  packageFilter.addEventListener('change', function () {
    ...
    packageBoxes.forEach(function (box) {
      if (selectedPackage === 'all') {
        ...
        const packageType = box.getAttribute('data-package');
  ...
  // Hanya tampilkan paket Mobile Legends saat halaman dimuat
  packageBoxes.forEach(function (box) {
    if (box.getAttribute('data-package') === 'mobile-legends') {
      box.style.display = 'block';
    } else {
      box.style.display = 'none';
    }
